...
@Data
@Schema(description = "Request model for ETX registration with vendor ID")
public class RegistrationPostRequestWithVendorId {
    ...
    @Schema(description = "Vendor identifier for the registration", required = true)
    private String vendorId;

    public RegistrationPostRequestWithVendorId(RegistrationPostRequest request, String vendorId) {
        this.clientType = request.getClientType();
        this.clientSubtype = request.getClientSubtype();
