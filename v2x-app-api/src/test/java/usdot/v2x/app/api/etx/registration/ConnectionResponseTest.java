...
import usdot.v2x.app.api.models.etx.registration.ConnectionResponse;
...
public class ConnectionResponseTest {
    ...
    public void testSerializationDeserialization() throws IOException, JSONException {
        ...
        String expectedJson = new String(
                Files.readAllBytes(
                        Paths.get(
                                "src/test/resources/com/neaera/cvmec/api/etx/registration/ConnectionResponse.json")));
        ObjectMapper objectMapper = new ObjectMapper();
        // JavaTimeModule

        ConnectionResponse geofence = objectMapper.readValue(expectedJson, ConnectionResponse.class);
