...
import usdot.v2x.app.api.models.etx.registration.RegistrationPostRequest;

public class RegistrationPostRequestTest {
    @Test
    public void testSerializationDeserialization() throws IOException, JSONException {
        ...
        RegistrationPostRequest geofence = objectMapper.readValue(expectedJson, RegistrationPostRequest.class);
